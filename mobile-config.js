App.info({
  id: 'za.co.multimobile.rover.enco.production',
  name: 'Enco D-Orders',
  description: 'Enco D-Orders, POD Capture and transmission for faster billing.',
  version: '0.0.1'
});
App.accessRule("*");
App.icons({
...
App.launchScreens({
	...
	"android_xxhdpi_landscape": "resources/splash/android/drawable-land-xxhdpi/screen.png",
	...
	"android_xxhdpi_portrait": "resources/splash/android/drawable-xxhdpi/screen.png",
